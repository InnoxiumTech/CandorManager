...
public class JarLoader {
     ...
     * include the line {@code Premain-Class: ca.cgjennings.ca.cgjennings.jvm.JarLoader}.
     *
     ...
     * <p>
     * For this to work the {@code MANIFEST.MF} file <strong>must</strong>
     * include the line {@code Agent-Class: ca.cgjennings.ca.cgjennings.jvm.JarLoader}.
     *
     * @param agentArgs agent arguments; currently ignored
     * @param instrumentation provided by the JRE
     */
